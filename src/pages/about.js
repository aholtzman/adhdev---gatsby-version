...
const About = () => (
  <Text>
    ...
    <p>Adam is a former chef, an art dealer and exhibiting artist (photography and painting). He has been known to produce photography and art books; designing, editing and intermittently publishing many since 2007.</p>
  </Text>
)
